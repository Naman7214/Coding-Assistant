...
class FileReadService:
    ...
    async def read_file(self, file_path: str, start_line: Optional[int], end_line: Optional[int], explanation: str):
        try:
            ...
            raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"Error reading file {file_path}: {str(e)}")