...
from src.app.usecases.modification_tools.search_replace_usecase import SearchReplaceUseCase


class SearchReplaceController:
    def __init__(self, search_replace_usecase: SearchReplaceUseCase = Depends()):
