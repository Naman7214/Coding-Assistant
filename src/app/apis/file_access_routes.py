...
from src.app.controllers.file_access_tools.directory_list_controller import (
    DirectoryListController,
)
from src.app.controllers.file_access_tools.file_deletion_controller import (
    FileDeletionController,
)
from src.app.controllers.file_access_tools.file_read_controller import (
    FileReadController,
)
from src.app.controllers.file_access_tools.file_search_controller import (
    FileSearchController,
)
from src.app.models.schemas.file_access_schemas import (
...
async def read_file(
    ...
    file_read_controller: FileReadController = Depends(FileReadController),
):
