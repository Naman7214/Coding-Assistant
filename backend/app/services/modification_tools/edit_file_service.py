...
class EditFileService:
    ...
    async def edit_file(self, target_file_path: str, code_snippet: str, explanation: str):
        try:
            ...
            try:
                edited_content = await self._apply_code_changes(original_content, code_snippet)
    ...
    async def _apply_code_changes(self, original_code: str, code_snippet: str) -> Optional[str]:
        """
        ...
        try:
            ...
            if "<updated-code>" in edited_content and "</updated-code>" in edited_content:
