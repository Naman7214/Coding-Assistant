...
class DirectoryListService:
    ...
    async def list_directory(
        ...
        try:
            ...
            async def process_directory(current_path: str) -> List[Dict[str, Any]]:
                items = []
            ...
            raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"Error listing directory {dir_path}: {str(e)}") 