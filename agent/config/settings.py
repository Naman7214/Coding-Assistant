...
class Settings(BaseSettings):
    ...
    MAX_TOOL_CALLS_PER_SESSION: int = int(
        os.getenv("MAX_TOOL_CALLS_PER_SESSION", 25)
    )

    # MongoDB settings
    MONGODB_URI: str = os.getenv("MONGODB_URI", "mongodb://localhost:27017")
    MONGODB_DB_NAME: str = os.getenv("MONGODB_DB_NAME", "agent_memory")
    MONGODB_CONVERSATION_COLLECTION: str = os.getenv(
        "MONGODB_CONVERSATION_COLLECTION", "conversations"
    )
